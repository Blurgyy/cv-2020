...
// implementation because it lucks some important general functions for
// general list, like remove_item() The head block may be not full For regular
// 2D grids, it's better to set GCLL_BLOCK_SIZE to 2 For other graphs, it
// should be set to the average expected number of neighbors Data in linked
// list for the neighborhood system is allocated in blocks of size
// GCLL_BLOCK_SIZE
