...
/*
   ...
   regularity for terms E^{i}, E^{i,j}, E^{i,j,k} are given below as comments
   to functions add_term1(), add_term2(), add_term3().
...
class Energy : public Graph<captype, tcaptype, flowtype> {
  ...
  public:
    ...
    void add_term3(Var x, Var y, Var z, Value E000, Value E001, Value E010,
                   Value E011, Value E100, Value E101, Value E110,
                   Value E111);
...
inline void Energy<captype, tcaptype, flowtype>::add_term3(
    ...
    register Value pi =
        (E000 + E011 + E101 + E110) - (E100 + E010 + E001 + E111);
